...
class MeanVarianceRequest(BaseModel):
    ...
    returns_data: Optional[List[List[float]]] = None  # Historical returns for CVaR/Sortino/Calmar
    lookback_periods: Optional[int] = Field(252, ge=50, le=1000)  # For Calmar ratio calculation

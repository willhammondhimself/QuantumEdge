...
import numpy as np
import pytest
from src.quantum_algorithms.qaoa import (
    PortfolioQAOA, QAOACircuit, QAOAResult
)
...
class TestQAOACircuit:
    ...
    def test_cost_hamiltonian_application(self):
        ...
        self.qaoa_circuit.apply_cost_hamiltonian(circuit, gamma=0.5, cost_matrix=cost_matrix)
...
class TestPortfolioQAOA:
    ...
    def test_cost_matrix_creation(self):
        ...
        for i in range(3):
            expected_diag = -expected_returns[i] + risk_aversion * covariance_matrix[i, i]
    ...
    def test_portfolio_cost_evaluation(self):
        ...
        expected_return = portfolio[0] * expected_returns[0] + portfolio[2] * expected_returns[2]
        risk = (portfolio[0]**2 * covariance_matrix[0,0] + 

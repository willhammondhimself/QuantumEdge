...
class TestQuantumVQE:
    ...
    def test_cost_function(self):
        ...
        params = np.random.uniform(
            0, 2 * np.pi, size=self.vqe.circuit_template.num_params
        )
    ...
    def test_solve_eigenportfolio_small(self):
        ...
        cov_matrix = np.array([[1.0, 0.3], [0.3, 1.0]])
    ...
    def test_solve_eigenportfolio_convergence(self):
        ...
        vqe = QuantumVQE(num_assets=3, depth=2, max_iterations=100, optimizer="COBYLA")
    ...
    def test_multiple_eigenportfolios(self):
        ...
        cov_matrix = np.array([[2.0, 0.5, 0.2], [0.5, 1.0, 0.3], [0.2, 0.3, 1.5]])

        # Small numbers for testing
        vqe = QuantumVQE(num_assets=3, depth=1, max_iterations=20)

        results = vqe.compute_multiple_eigenportfolios(
            cov_matrix, num_eigenportfolios=2, num_random_starts=2
        )
...
class TestJAXVQEOptimizer:
    ...
    def test_jax_optimization(self):
        ...
        result = self.optimizer.optimize_with_jax(
            cov_matrix, learning_rate=0.1, num_steps=50  # Small number for testing
        )

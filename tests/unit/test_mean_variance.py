...
class TestMeanVarianceOptimizer:
    ...
    def test_initialization(self):
        ...
        assert self.optimizer.solver_preference[0] == "OSQP"
    ...
    def test_turnover_constraint(self):
        ...
        constraints = PortfolioConstraints(
            max_turnover=0.2, current_weights=current_weights
        )
    ...
    def test_efficient_frontier_computation(self):
        ...
        if len(returns) > 1:
            ...
            assert len(weights[0]) == len(self.expected_returns)
    ...
    def test_single_asset_portfolio(self):
        ...
        result = self.optimizer.optimize_portfolio(
            single_return, single_cov, objective=ObjectiveType.MAXIMIZE_UTILITY
        )
...
class TestRobustOptimizer:
    ...
    def setup_method(self):
        """Set up test fixtures."""
        self.optimizer = RobustOptimizer(risk_free_rate=0.02, uncertainty_level=0.1)
    ...
    def test_initialization(self):
        ...
        assert hasattr(self.optimizer, "optimize_robust_portfolio")
    ...
    def test_robust_vs_standard_comparison(self):
        ...
        # Create a standard optimizer for comparison
        standard_optimizer = MeanVarianceOptimizer(solver_preference=["cvxpy"])

        # Standard optimization
        standard_result = standard_optimizer.optimize_portfolio(
            self.expected_returns,
            self.covariance_matrix,
            objective=ObjectiveType.MAXIMIZE_UTILITY,
        )
...
class TestPortfolioConstraints:
    ...
    def test_custom_constraints(self):
        ...
        constraints = PortfolioConstraints(
            long_only=False, max_weight=0.3, min_return=0.08, forbidden_assets=[0, 2]
        )
